                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mt-8">
                      <div className="text-center p-4 sm:p-6 bg-blue-50 rounded-xl">
                        <Clock className="w-8 h-8 sm:w-12 sm:h-12 text-blue-600 mx-auto mb-4" />
                        ...
                        <p className="text-xs sm:text-sm text-gray-600">
                          Perfect untuk acara singkat
                        </p>
                      </div>

                      <div className="text-center p-4 sm:p-6 bg-green-50 rounded-xl border-2 border-green-200 sm:col-span-2 lg:col-span-1">
                        <Clock className="w-8 h-8 sm:w-12 sm:h-12 text-green-600 mx-auto mb-4" />
                        <h4 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">
                          Sewa 24 Jam
                        </h4>
                        ...
                        <p className="text-xs sm:text-sm text-gray-600">
                          Ideal untuk acara sehari penuh
                        </p>
                      </div>

                      <div className="text-center p-4 sm:p-6 bg-purple-50 rounded-xl sm:col-start-2 lg:col-start-auto">
                        <Clock className="w-8 h-8 sm:w-12 sm:h-12 text-purple-600 mx-auto mb-4" />
                        <h4 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">
                          Sewa 2 Hari
                        </h4>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mt-8">
                      <div className="text-center p-4 sm:p-6 bg-blue-50 rounded-xl border-2 border-blue-200">
                        ...
                        <div className="text-lg sm:text-xl lg:text-2xl font-bold text-blue-600 mb-2">
                          Rp 110.000 - 130.000
                        </div>
                        ...
                        <p className="text-xs text-gray-500 mt-2">
                          *Tergantung tingkat kesulitan desain
                        </p>
                      </div>
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://wa.me/6282151106559?text=Halo, saya tertarik dengan layanan Gypshophila Boardy",
                    "_blank"
                  )
                }
              >
